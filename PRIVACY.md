...
All data remains **on your device** and is used only to provide app functionality. The app does **not**:
...
## Security
Since all data is stored locally, it remains under your control. Regular device backups are recommended to prevent data loss.

## Changes to This Privacy Policy
Any updates to this policy will be reflected on this page with an updated “Effective Date.”
